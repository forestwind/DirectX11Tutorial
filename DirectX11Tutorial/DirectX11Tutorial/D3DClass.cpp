...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	// 팩토리 객체를 사용해 첫번째 그래픽카드 인터페이스 어뎁터 생성
	...
	// 찾으면 모니터의 새로고침 비율의 분모와 분자 값을 저장
	...
	// 스왑체인, Direct3D 장치 및 Direct3D 장치 컨텍스트를 만듬
...
{
	//종료 전 윈도우 모드로 설정하지 않으면 스왑체인을 해제 할때 예외 발생
	if (m_swapChain)
	{
